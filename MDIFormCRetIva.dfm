object fmSistemFact: TfmSistemFact
  ...
  object Panel1: TPanel
    ...
    object ToolBar1: TToolBar
      ...
      object sistSolicitudes: TToolButton
        Left = 0
        Top = 0
        Hint = 'Facturaci'#243'n Ordenes Obras Sociales'
        AutoSize = True
      ...
      object sistDeduccion: TToolButton
        Left = 23
        Top = 0
        Hint = 'Presupuesto R'#225'pido'
        AutoSize = True
        Caption = '&Pres.R'#225'pido '
        ImageIndex = 2
        ParentShowHint = False
        ShowHint = True
      ...
      object sistArchivos: TToolButton
        Left = 48
        Top = 0
      ...
      object sistProfesionales: TToolButton
        ...
        DropdownMenu = PopupMenuLaboratorios
        ImageIndex = 5
        ParentShowHint = False
        PopupMenu = PopupMenuLaboratorios
        ShowHint = True
  ...
  object MainMenu: TMainMenu
    ...
    object Sistema1: TMenuItem
      ...
      object ExportarFacturacinSoporteMagntico1: TMenuItem
        ...
        Enabled = False
        OnClick = ExportarFacturacinSoporteMagntico1Click
      end
      ...
      object FacturacinGlobaldeObrasSociales1: TMenuItem
        ...
        Enabled = False
        OnClick = FacturacinGlobaldeObrasSociales1Click
      end
      object DistribucindeOrdenesFacturadas1: TMenuItem
        Caption = 'Distribuci'#243'n de Ordenes Facturadas'
        Enabled = False
        OnClick = DistribucindeOrdenesFacturadas2Click
      end
      object N15: TMenuItem
        Caption = '-'
      end
      object DescargarActualizacionesdeDatos1: TMenuItem
        Caption = '&Descargar Actualizaciones de Datos'
        OnClick = DescargarActualizacionesdeDatos1Click
      end
      object PresupuestoRpido1: TMenuItem
      ...
      object ExportacionesSoporteDigital1: TMenuItem
        Caption = 'Exportaciones Soporte Digital'
        Enabled = False
        OnClick = ExportacionesSoporteDigital1Click
      end
    ...
    object Archivo1: TMenuItem
      ...
      object AdministracindeMaestros1: TMenuItem
        ...
        object NminadePacientes1: TMenuItem
          Caption = 'N'#243'mina de Pacientes'
          OnClick = sistPacientesClick
        end
        object N9: TMenuItem
          Caption = '-'
    ...
    object Depurar1: TMenuItem
      ...
      object DatosFactLaboratorios1: TMenuItem
        Caption = '&Facturaciones Laboratorios'
        ImageIndex = 2
    ...
    object General2: TMenuItem
      ...
      object ConfigurarAccesoaDatos1: TMenuItem
        Caption = 'Configurar Acceso a Datos Remotos'
        OnClick = ConfigurarAccesoaDatos1Click
      end
      object ConfiguracinFTP1: TMenuItem
        Caption = 'Configuraci'#243'n FTP'
        OnClick = ConfiguracinFTP1Click
      end
      object N2: TMenuItem
        Caption = '-'
      end
      object ProgramacindeRespaldos1: TMenuItem
        Caption = '&Par'#225'metros del Sistema'
        OnClick = ProgramacindeRespaldos1Click
      end
  ...
  object PopupMenuLaboratorios: TPopupMenu
    Left = 336
    Top = 120
    object DatosdeLaboratorios1: TMenuItem
    ...
    object Categoras1: TMenuItem
      Caption = 'Categor'#237'as de Laboratorios'
      OnClick = Categoras1Click
    end
  end
