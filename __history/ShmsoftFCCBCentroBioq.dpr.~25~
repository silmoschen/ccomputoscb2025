...
uses
  ...
  MDIForm in 'MDIForm.pas' {fmSistem},
  ...
  CMedicosCCB in '..\..\clases\CMedicosCCB.pas',
  ...
  fmFacturacionOnLine in 'fmFacturacionOnLine.pas' {fmFactOnLine},
  CAuditoriaFacturacion in 'clases\CAuditoriaFacturacion.pas',
  exportarOrdenesSopMagnetico in 'exportarOrdenesSopMagnetico.pas' {fmExportarOrdenesSoporteMagnetico},
  buscarosonline in 'buscarosonline.pas' {fmBuscarOrdenesOnLine},
...
begin
  ...
  fmIntroForm.Label2.Caption := 'Versión: 3.07.015';
  fmIntroForm.Show;
  fmIntroForm.Update;
