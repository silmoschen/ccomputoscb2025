object fmListNomeclaturaObrasSociales: TfmListNomeclaturaObrasSociales
  Left = 174
  Top = 109
  Caption = 'N'#243'mina Determinaciones Obras Sociales'
  ClientHeight = 358
  ClientWidth = 685
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object SpeedButton6: TSpeedButton
      ...
      Height = 24
      Hint = 
        'Marcar Aquellas Pr'#225'cticas con C'#225'lculo Basado en Unidades Diferen' +
        'ciales'
      Anchors = [akLeft, akTop, akBottom]
      Caption = '&D'
      Flat = True
  ...
  object Panel7: TPanel
    ...
    object filtroOS: TSpeedButton
      ...
      Width = 72
      Height = 23
      Hint = 'Seleccionar o Cambiar Obra Social'
      Caption = '&Obra Social'
      Flat = True
      ParentShowHint = False
      ShowHint = True
      OnClick = filtroOSClick
    end
    object codos: TLabel
      Left = 80
      Top = 5
