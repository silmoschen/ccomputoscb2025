...
var
  fmListCategorias: TfmListCategorias;

implementation

uses CCategoriasCCB, CUtiles, tabladecategorias;

{$R *.DFM}

procedure TfmListCategorias.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  if not introSalir then Begin
    categoria.desconectar;
    Release; fmListCategorias := nil;
  end;
end;

procedure TfmListCategorias.expresionChange(Sender: TObject);
begin
...
procedure TfmListCategorias.criterioClick(Sender: TObject);
begin
  ActiveControl := expresion;
end;

procedure TfmListCategorias.expresionKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if (Key = VK_RETURN) or (Key = VK_DOWN) then ActiveControl := DBGrid;
end;

procedure TfmListCategorias.SpeedButton1Click(Sender: TObject);
begin
  Application.CreateForm(TfmTablaCategorias, fmTablaCategorias);
  fmTablaCategorias.AltaClick(nil);
  fmTablaCategorias.ActiveControl := fmTablaCategorias.categ;
  fmTablaCategorias.NoCerrarFinal := True;
  fmTablaCategorias.ShowModal;
end;

procedure TfmListCategorias.SpeedButton2Click(Sender: TObject);
begin
  Application.CreateForm(TfmTablaCategorias, fmTablaCategorias);
  fmTablaCategorias.NoCerrarFinal    := True;
  fmTablaCategorias.idcategoria.Text := categoria.tabla.FieldByName('idcategoria').AsString;
  fmTablaCategorias.ShowModal;
end;

procedure TfmListCategorias.FormCreate(Sender: TObject);
begin
  Left:=(Screen.Width - Width) div 2; Top:=(Screen.Height - Height) div 2;
end;

procedure TfmListCategorias.DBGridKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TfmListCategorias.criterioChange(Sender: TObject);
begin
  expresion.Text := '';
  expresionChange(Sender);
end;

procedure TfmListCategorias.SpeedButton4Click(Sender: TObject);
begin
...
procedure TfmListCategorias.codigoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if Key = VK_RETURN then ActiveControl := desde;
end;

procedure TfmListCategorias.codigoClick(Sender: TObject);
begin
  criterio.Text := 'Código';
  expresionChange(Sender);
...
procedure TfmListCategorias.alfabeticoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if Key = VK_RETURN then ActiveControl := desde;
end;

procedure TfmListCategorias.alfabeticoClick(Sender: TObject);
begin
...
procedure TfmListCategorias.desdeKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if Key = VK_UP then
...
procedure TfmListCategorias.hastaKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TfmListCategorias.dispositivoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if Key = VK_RETURN then ActiveControl := emitir;
end;

procedure TfmListCategorias.emitirClick(Sender: TObject);
var
...
procedure TfmListCategorias.cerrarClick(Sender: TObject);
begin
...
procedure TfmListCategorias.FormShow(Sender: TObject);
begin
...
procedure TfmListCategorias.desdeClick(Sender: TObject);
begin
  control := 0;
end;

procedure TfmListCategorias.hastaClick(Sender: TObject);
begin
  control := 1;
end;

procedure TfmListCategorias.SpeedButton3Click(Sender: TObject);
begin
  Application.CreateForm(TfmTablaCategorias, fmTablaCategorias);
  fmTablaCategorias.idcategoria.Text := categoria.tabla.FieldByName('idcategoria').AsString;
  fmTablaCategorias.BajaClick(Sender);
