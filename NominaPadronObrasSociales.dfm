object fmListPadronObrasSociales: TfmListPadronObrasSociales
  Left = 173
  Top = 107
  Caption = 'Padron de Obras Sociales'
  ClientHeight = 342
  ClientWidth = 555
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object SpeedButton2: TSpeedButton
      ...
      Width = 102
      Height = 24
      Hint = 'Consultar, Modificar e Incorporar Afiliados a la Obra Social'
      Anchors = [akLeft, akTop, akBottom]
      Caption = '&Consultar Afiliados'
      Flat = True
      Layout = blGlyphTop
      Margin = 4
      ParentShowHint = False
