object fmSistemFact: TfmSistemFact
  ...
  object Panel1: TPanel
    ...
    object ToolBar1: TToolBar
      ...
      EdgeInner = esLowered
      EdgeOuter = esNone
      HotImages = contenedorImg.ImagSistema
      Images = contenedorImg.ImageBN
      ShowCaptions = True
      TabOrder = 0
      object sistSolicitudes: TToolButton
        ...
        Top = 0
        Hint = 
          'Esta Opci'#243'n le Permite Registrar'#13#10'las Operaciones de Facturaci'#243'n' +
          ' de '#13#10'Obras Sociales en Forma Manual'
        AutoSize = True
      ...
      object sistPacientes: TToolButton
        Left = 213
        Top = 0
        Hint = 'Mantenimiento Datos de Pacientes'
        AutoSize = True
        Caption = ' &Pacientes   '
        ImageIndex = 7
        ParentShowHint = False
      ...
      object sistNomeclador: TToolButton
        Left = 282
        Top = 0
        Hint = 'Consultas Nomeclador Nacional Normalizado'
        AutoSize = True
        Caption = '&Nomeclador'
        ImageIndex = 2
        ParentShowHint = False
  ...
  object Panel2: TPanel
    ...
    object ToolBar2: TToolBar
      ...
      ShowCaptions = True
      TabOrder = 0
      object sisEstadisticas: TToolButton
        Left = 0
        Top = 0
        Hint = 'Informes y Gr'#225'ficos Estad'#237'sticos'
        AutoSize = True
      ...
      object sisDepurar: TToolButton
        Left = 70
        Top = 0
        Hint = 'Depurar Informaci'#243'n del Sistema'
        AutoSize = True
        Caption = '  &Depurar   '
        ImageIndex = 11
        ParentShowHint = False
      ...
      object sisAuditoria: TToolButton
        Left = 135
        Top = 0
        Hint = 'Presentaci'#243'n de Informes de Auditor'#237'a'
      ...
      object sisBackup: TToolButton
        Left = 204
        Top = 0
        Hint = 'Respaldo y Restauraci'#243'n de Datos'
        AutoSize = True
        Caption = '   &Backup   '
        ImageIndex = 9
  ...
  object MainMenu: TMainMenu
    ...
    object Archivo1: TMenuItem
      ...
      object AdministracindeMaestros1: TMenuItem
        ...
        object Nomeclador1: TMenuItem
          Caption = 'Nomeclador Naciomal Normalizado'
          ImageIndex = 14
          OnClick = sistNomecladorClick
        end
    ...
    object General2: TMenuItem
      ...
      object ProgramacindeRespaldos1: TMenuItem
        Caption = '&Programaci'#243'n de Respaldos'
  ...
  object PopupMenuPersonalizarEntorno: TPopupMenu
    ...
    object QuitarSkin1: TMenuItem
      Caption = 'Quitar Skin'
      OnClick = QuitarSkin1Click
    end
  end
