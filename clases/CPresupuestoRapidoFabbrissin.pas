...
TTpresupuestoAnalisis = class(TObject)
 public
  ...
  procedure   ImprimirPresupuestoRapido(salida: char); overload;
  procedure   ImprimirPresupuestoRapido(xt1, xt2, xt3: string; salida: char); overload;
...
procedure   TTpresupuestoAnalisis.ImprimirPresupuestoRapido(xt1, xt2, xt3: string; salida: char);
// Objetivo...: Imprimir Presupuesto rápido
var
  i: Integer;
Begin
  ...
  if (xt1 <> '') then list.Titulo(0, 0, xt1, 1, 'Arial, negrita, 10');
  if (xt2 <> '') then list.Titulo(0, 0, xt2, 1, 'Arial, negrita, 10');
  if (xt3 <> '') then list.Titulo(0, 0, xt3, 1, 'Arial, negrita, 10');
