...
uses
  ...
  Comprobantes in '..\SFact\Comprobantes.pas' {fmComprobantes},
  ...
  MDIFormLaboratoriosSJ in 'MDIFormLaboratoriosSJ.pas' {fmSistemCCB},
  ...
  DefinicionFacturas in 'DefinicionFacturas.pas' {fmDefFacturas},
  ...
  AbrirCarpeta in '..\..\Interfases\AbrirCarpeta.pas' {fmSelectCarpeta},
...
begin
  ...
  fmIntroForm.Label1.Caption := 'Fact. Obras Sociales Laboratorios Análisis Clínicos';
  fmIntroForm.Label2.Caption := 'Versión: 3.09.015';
  fmIntroForm.Show;
  fmIntroForm.Update;
  Application.Initialize;
  Application.CreateForm(TfmSistemCCB, fmSistemCCB);
  fmIntroForm.Hide;
