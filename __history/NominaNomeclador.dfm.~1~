object fmListNomeclador: TfmListNomeclador
  Left = 137
  Top = 109
  ...
  object Panel1: TPanel
    ...
    object SpeedButton5: TSpeedButton
      ...
      Width = 39
      Height = 24
      Hint = 'Fijar '#243' Quitar Marca para C'#243'digos de Qu'#237'mica'
      Anchors = [akLeft, akTop, akBottom]
      Caption = '&Sel. Q.'
      Flat = True
      Layout = blGlyphTop
    ...
    object SpeedButton6: TSpeedButton
      ...
      Width = 39
      Height = 24
      Hint = 'Fijar-Quitar Marca para C'#243'digos de Facturaci'#243'n'
      Anchors = [akLeft, akTop, akBottom]
      Caption = '&Fact.'
      Flat = True
      Layout = blGlyphTop
