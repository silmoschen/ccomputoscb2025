...
const
  version = '4.01.001'; //version = '3.07.009';
...
type
  TfmSistemCCB = class(TForm)
    ...
    NomencladorUnicioBioqumico1: TMenuItem;
    NomencladorUnicioBioqumico2: TMenuItem;
    ...
    procedure NomencladorUnicioBioqumico1Click(Sender: TObject);
...
uses CUtiles, CBDT, ImgForms, NominaPacientes, NominaNomeclador,
  ...
  BajarActualizacionesOnLine, CExpira, Nomina_NBU, RepararDatosParadox;
...
begin
  ...
  //actualizaciones.Version('3.01.17'); No Aplicable
...
procedure TfmSistemCCB.Estadisticas1Click(Sender: TObject);
begin
...
procedure TfmSistemCCB.NomencladorUnicioBioqumico1Click(Sender: TObject);
begin
