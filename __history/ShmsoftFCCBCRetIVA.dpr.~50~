...
uses
  ...
  MsgSiNo1 in '..\..\Interfases\MsgSiNo1.pas' {MensajeSiNo1},
  MsgSiNo in '..\..\Interfases\MsgSiNo.pas' {MensajeSiNo},
  ...
  MDIFormCRetIva in 'MDIFormCRetIva.pas' {fmSistemFact},
  ...
  ProgBackup in '..\..\Interfases\ProgBackup.pas' {fmConfigBackup},
  ...
  Nomina_NBU in 'clases\Nomina_NBU.pas' {fmListNBU},
  ...
  distribucionOrdenesFacturadas in 'distribucionOrdenesFacturadas.pas' {fmDistribucionOrdenesFacturadas},
  ...
  login_user in 'login_user.pas' {fmLogin},
...
begin
  ...
  fmIntroForm.Label1.Caption := 'Facturación Laboratorios de Análisis Clinicos';
  fmIntroForm.Label2.Caption := 'Versión: 4.05.056';
  fmIntroForm.Show;
  fmIntroForm.Update;
