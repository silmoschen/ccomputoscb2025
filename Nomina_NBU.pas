...
procedure TfmListNBU.DBGridDrawColumnCell(Sender: TObject; const Rect: TRect;
  DataCol: Integer; Column: TColumn; State: TGridDrawState);
const
...
procedure TfmListNBU.SpeedButton6Click(Sender: TObject);
begin
  nbu.MarcarPracticaDiferencial(nbu.tabla.FieldByName('codigo').AsString);
end;
