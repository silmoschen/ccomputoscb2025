object fmSistemCCB: TfmSistemCCB
  ...
  object MainMenu: TMainMenu
    ...
    object Archivo1: TMenuItem
      ...
      object AdministracindeMaestros1: TMenuItem
        Caption = '&Mantenimiento Datos Maestros'
        object Nomeclador1: TMenuItem
          Caption = 'Nomenclador Nacional Normalizado'
          ImageIndex = 14
          OnClick = sistNomecladorClick
        end
        object NomencladorUnicioBioqumico2: TMenuItem
          Caption = 'Nomenclador Unicio Bioqu'#237'mico'
          OnClick = NomencladorUnicioBioqumico1Click
        end
  ...
  object PopupMenuArchivo: TPopupMenu
    ...
    object NomencladorUnicioBioqumico1: TMenuItem
      Caption = 'Nomenclador Unicio Bioqu'#237'mico'
      OnClick = NomencladorUnicioBioqumico1Click
    end
