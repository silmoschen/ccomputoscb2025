object fmSistem: TfmSistem
  Left = 14
  Top = 144
  Caption = 'shmSOFT - Administraci'#243'n Central de Bioqu'#237'micos'
  ClientHeight = 429
  ClientWidth = 786
  Color = clBtnShadow
  ParentFont = True
  ...
  object Panel1: TPanel
    ...
    object ToolBar1: TToolBar
      ...
      object sistAuditoria: TToolButton
        Left = 23
        Top = 0
        Hint = 'Auditor'#237'a de Obras Sociales Capitadas'
        AutoSize = True
      ...
      object sistLiquidacion: TToolButton
        Left = 46
        Top = 0
        Hint = 'Distribuci'#243'n Pagos Obras Sociales'
        AutoSize = True
        Caption = ' &Dist. O.S.'
  ...
  object MainMenu: TMainMenu
    ...
    object Sistema1: TMenuItem
      ...
      object AuditoaOrdenesObrasSociales1: TMenuItem
        ...
        object IngresodeOrdenesdeAuditora1: TMenuItem
          Caption = 'Ingreso de Ordenes de Auditor'#237'a'
          OnClick = sisAuditoriaClick
        end
        object SincronizacindeOrdenesdeAuditora1: TMenuItem
          Caption = 'Sincronizaci'#243'n de Ordenes de Auditor'#237'a'
      ...
      object ExportarOrdenesSoporteDigital1: TMenuItem
        Caption = 'Exportar Ordenes Soporte Digital'
        OnClick = ExportarOrdenesSoporteDigital1Click
      end
      object N1: TMenuItem
        Caption = '-'
      end
    ...
    object Estadistica1: TMenuItem
      ...
      object GeneracinEstadsticaIAPOS1: TMenuItem
        Caption = '&Generaci'#243'n Estad'#237'stica I.A.P.O.S.'
        OnClick = GeneracinEstadsticaIAPOS1Click
      end
      object ExportacindeDatosEstadsticos1: TMenuItem
        Caption = '&Exportaci'#243'n de Datos Estad'#237'sticos'
        Enabled = False
        OnClick = ExportacindeDatosEstadsticos1Click
      end
      object N5: TMenuItem
        Caption = '-'
      end
    ...
    object General2: TMenuItem
      ...
      object ReglasdeExportacinObrasSociales1: TMenuItem
        Caption = 'Reglas de Exportaci'#243'n Obras Sociales'
        OnClick = ReglasdeExportacinObrasSociales1Click
      end
      object ConfiguracinAccesoaDatosRemotos1: TMenuItem
        Caption = 'Configuraci'#243'n Acceso a Datos Remotos'
        OnClick = ConfiguracinAccesoaDatosRemotos1Click
      end
      object ConfiguracinFTPHTTPWS1: TMenuItem
        Caption = 'Configuraci'#243'n FTP, HTTP, WS'
        OnClick = ConfiguracinFTPHTTPWS1Click
      end
      object N2: TMenuItem
        Caption = '-'
      end
